 ...
 * @method QueryList find($selector)
 ...
 * @method QueryList getData(Closure $callback = null)
 * @method QueryList setData(\Tightenco\Collect\Support\Collection $data)
 ...
 * @method QueryList all()
 * @method QueryList html($html, $charset = null)
 */
class QueryList
{
    protected $query;
